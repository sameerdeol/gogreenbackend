...
router.post('/getvendor-status', verifyToken ,vendorController.getVendorStatus);
router.post('/vendordashboard-analytics', verifyToken, vendorController.vendorDashboardAnalytics);
