...
const vendorVerification = async (req, res) => {
    try {
        req.body.role_id = 3;
        const { role_id, storename, storeaddress, sincode, countrystatus, user_id, license_number, business_reg_number, vendor_type_id, vendor_start_time, vendor_close_time,vendor_lat, vendor_lng } = req.body;
